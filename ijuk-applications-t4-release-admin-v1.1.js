...
function addStyle(){
  ...
  s.textContent=`
    ...
    /* Fiber-aware visibility contract: legacy switcher may add nf-hidden-by-fiber,
       but a fiber-aware panel that is not logically [hidden] must remain visible. */
    #view-preview > [data-nf-fiber-aware="1"].nf-hidden-by-fiber:not([hidden]),
    #view-review > [data-nf-fiber-aware="1"].nf-hidden-by-fiber:not([hidden]){display:block!important}
