/*
 NatFiber Encyclopedia — Product Application Gallery v1.0
...
(function(){
  ...
  function mediaSrc(m){
    return safeUrl(m?.asset_path||m?.original_file_url||'');
  }
  ...
  function boot(){
    ...
    watch();
    console.info('[NatFiber] Product Application Gallery v1.0 loaded.');
  }
