// NatFiber Encyclopedia — client configuration v1.7.3 · Admin Stabilization Patch 3
window.NATFIBER_EDITOR_VERSION='1.6.2';
...
if(/\/admin\.html$/.test(window.location.pathname)){
 nfLoadScript('admin-stabilization-v1.6.0.js?v=1.6.2',{onload:()=>{
   nfLoadScript('admin-active-fiber-sync-v1.6.2.js?v=1.6.2');
   nfLoadScript('admin-review-release-router-v1.6.1.js?v=1.6.2');
